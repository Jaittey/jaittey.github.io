...
export const PLAN_DEFINITIONS = {
  SILVER: {
    ...
    highlights: ['POS','Quotations','Invoices','Customers','Inventory'],
  },
  GOLD: {
    id: 'GOLD', name: 'VIP Gold', tagline: 'Commerce, operations and workforce', level: 2,
    pages: [
      ...
      'employees','hr-records','payroll','final-settlements','attendance','attendance-settings','preferences',
    ],
    highlights: [
      'Everything in Silver','Adaptive POS','Suppliers & Purchase Orders','Marketplace Order Hub',
      'Restaurant Kitchen','Garage Service Jobs','Employee Management','Payroll & Attendance',
    ],
  },
  PLATINUM: {
    ...
    pages: [
      ...
      'finance','income-payments','expenses','budget','tax','reports','cloud','notifications','preferences',
    ],
    highlights: [
      'Everything in Gold','Financial Management','Reports & Analytics','Cloud & Documents',
      'Google Drive','Business Backup & Restore',
    ],
  },
};
...
export const isSubscriptionActive = (subscription = {}) => {
  ...
  const ends = typeof subscription.endsAt?.toDate === 'function'
