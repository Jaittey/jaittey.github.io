...
export const PLAN_DEFINITIONS = {
  SILVER: {
    ...
    pages: ['dashboard','sales-dashboard','inventory-assets','pos','quotes','invoices','customers','products','preferences'],
  ...
  GOLD: {
    ...
    pages: ['dashboard','sales-dashboard','inventory-assets','pos','quotes','invoices','billing','payments','customers','contracts','statements','employees','hr-records','payroll','attendance','attendance-settings','products','suppliers','assets','preferences'],
  ...
  PLATINUM: {
    ...
    pages: ['dashboard','sales-dashboard','inventory-assets','pos','quotes','invoices','billing','payments','customers','contracts','statements','employees','hr-records','payroll','attendance','attendance-settings','finance','expenses','budget','tax','products','suppliers','assets','reports','cloud','notifications','preferences'],
