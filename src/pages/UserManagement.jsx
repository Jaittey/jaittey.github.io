...
export default function UserManagement({ users, notify }) {
  ...
  const remove = async (record) => {
    if (!window.confirm(`Remove all DF7 access for ${record.email}?`)) return;
      ...
      {editor && (
        ...
        >
            ...
            <section className="permission-control-panel">
              <div className="permission-control-heading">
                <div>
                  ...
                  <p>
                    {form.role === 'manager'
                      ? 'Managers receive the complete operational workspace by default. Enable customization only when this specific Manager must be restricted.'
          ...
          <div className="alert alert-info">
            Permission changes apply to logged-in users automatically. Passwords remain private in Firebase Authentication.
          </div>
