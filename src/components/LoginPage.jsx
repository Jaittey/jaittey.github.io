  ...
  return (
    <main className="login-page v21-login">
      ...
      <section className="login-showcase" aria-label="Small Business platform overview">
        <div className="login-showcase-brand"><span>SB</span><div><strong>Small Business</strong><small>One workspace. Complete control.</small></div></div>
        <div className="login-showcase-copy">
          ...
          <p>Sales, finance, people, inventory, and documents come together in one secure workspace that stays fast as you grow.</p>
        </div>
        <div className="login-preview-stack" aria-hidden="true">
          <article className="login-preview-card preview-primary"><header><span>Business pulse</span><b>Live</b></header><strong>MVR 128,450</strong><small>Revenue this month</small><div className="preview-chart"><i/><i/><i/><i/><i/><i/></div></article>
          <article className="login-preview-card preview-floating"><span>↗</span><div><small>Net position</small><strong>+18.4%</strong></div></article>
          <article className="login-preview-card preview-team"><div><span>AN</span><span>MK</span><span>SA</span></div><strong>12 teammates active</strong></article>
        </div>
        <div className="login-trust-row"><span><i>✓</i> Company data isolation</span><span><i>✓</i> Secure cloud sync</span><span><i>✓</i> Built for every screen</span></div>
      </section>
